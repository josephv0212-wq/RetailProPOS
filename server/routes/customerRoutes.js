...
import { getCustomers, getCustomerById, getCustomerByLocation, getCustomerPriceList, getCustomerPaymentProfiles, getCustomerCheckoutData, invalidatePaymentProfilesCacheHandler, getAutoInvoiceCustomers, addAutoInvoiceCustomer, removeAutoInvoiceCustomer, createZohoCardLink } from '../controllers/customerController.js';
...
router.post('/:id/zoho-card-link', authenticate, createZohoCardLink);
